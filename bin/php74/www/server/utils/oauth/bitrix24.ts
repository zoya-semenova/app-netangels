...
// @todo remove this
// @ts-expect-error wait PR https://github.com/atinux/nuxt-auth-utils/pull/409
import { handleMissingConfiguration, handleAccessTokenErrorResponse, requestAccessToken, handleState, handleInvalidState } from 'nuxt-auth-utils-runtime'
...
export interface OAuthBitrix24Config {
   ...
   * @default 'https://oauth.bitrix24.tech/oauth/token/'
   */
  tokenURL?: string
}
...
console.log('start token')
    const tokens = await requestAccessToken('https://oauth.bitrix24.tech/oauth/token/', {
      body: {
